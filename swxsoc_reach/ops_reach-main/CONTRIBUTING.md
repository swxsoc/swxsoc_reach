...
* Submit bug reports and feature requests at [GitHub](https://github.com/jklenzing/ops_reach/issues)
...
When [reporting a bug](https://github.com/jklenzing/ops_reach/issues) please
include:
...
[GitHub](https://github.com/jklenzing/ops_reach/issues).
...
To set up `ops_reach` for local development:

1. [Fork ops_reach on GitHub](https://github.com/jklenzing/ops_reach/fork).

2. Clone your fork locally:

  ```
    git clone git@github.com:your_name_here/ops_reach.git
  ```
...
3. Create a branch for local development:
  ...
  ```
   ...
   ``ops_reach/tests``.  If no test file exists, then you should
...
7. Commit your changes:
   ...
   `ops_reach` follows the [numpy development workflow](https://numpy.org/doc/stable/dev/development_workflow.html),
...
In general, ops_reach follows PEP8 and numpydoc guidelines.  Pytest runs the unit
