...
export filetype="cdf"
#export endday="2" #2 is representing that we're grabbing and just updating the 
...
python /tcs/ago/group/ampere2_reach/reachcode/python/REACH_Plots/cron_UDL_append_RI.py
