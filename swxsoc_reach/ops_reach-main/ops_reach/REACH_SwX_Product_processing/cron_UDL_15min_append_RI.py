...
start_time = now #start_time = dt.datetime(2017, 3, 10, 0, 0, 0) this would go back to the begining of reach
...
cdforcsv = os.environ['filetype']#'cdf' #this can be specified as csv, cdf, or now 
...
version = 'v1.29' #this is the version of the data to be used. Currently this is only used by the cdf files but may be expanded later. 
...
for d in loop_days:
    ...
    for i, j in zip(flav, dose):
        ...
        URI.append_reach_index(startday =  days, endday = days + dt.timedelta(days = 1), 
