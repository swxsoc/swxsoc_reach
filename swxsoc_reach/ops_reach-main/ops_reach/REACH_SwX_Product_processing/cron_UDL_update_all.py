...
start_time = dt.datetime(2017, 3, 10, 0, 0, 0) #this would go back to the begining of reach
end_time = now 
...
version = 'v1.29' #the version of the data used. Currently only needed for cdf files, but may be updated for all. 
