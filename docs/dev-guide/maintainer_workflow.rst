...
Now you need to push the changes you have made to the code to the open pull request::
    ...
    $ git push git@github.com:<username>/swxsoc_reach.git HEAD:<name of branch>
...
.. _step by step checklist: https://github.com/swxsoc/swxsoc_reach/wiki/Release-Process